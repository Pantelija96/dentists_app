...
@section('additionalPluginCSS')
    ...
    <link rel="stylesheet" href="{{ asset('assets/assets/vendor_assets/css/jquery-jvectormap-2.0.5.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/assets/vendor_assets/css/jquery.mCustomScrollbar.min.css') }}">
...
@section('content')
    <section class="work-page">
        <form method="POST" enctype="multipart/form-data" action="{{ route('work.update', $work->id) }}">
        @csrf
        <!-- GORNJI DEO: zubi + form polja -->
            <div class="work-main">
                <!-- Levo: slika/diagram zuba -->
                <div class="work-teeth">
                    <div class="tooth-chart">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 450 700" enable-background="new 0 0 450 700" xml:space="preserve">
                  <g id="toothLabels">
                      <text class="lbl" transform="matrix(1 0 0 1 97.9767 402.1409)" font-family="'Jost'" font-size="21px">48</text>
                      <text class="lbl" transform="matrix(1 0 0 1 94.7426 449.1693)" font-family="'Jost'" font-size="21px">47</text>
                      <text class="lbl" transform="matrix(1 0 0 1 106.0002 495.5433)" font-family="'Jost'" font-size="21px">46</text>
                      <text class="lbl" transform="matrix(1 0 0 1 118.0002 538.667)" font-family="'Jost'" font-size="21px">45</text>

                      <text class="lbl" transform="matrix(0.9999 -1.456241e-02 1.456241e-02 0.9999 136.4086 573.5098)" font-family="'Jost'" font-size="21px">44</text>
                      <text class="lbl" transform="matrix(1 0 0 1 157.3335 603.8164)" font-family="'Jost'" font-size="17px">43</text>
                      <text class="lbl" transform="matrix(1 0 0 1 179.3335 623.8164)" font-family="'Jost'" font-size="18px">42</text>
                      <text class="lbl" transform="matrix(1 0 0 1 204.6669 628.483)" font-family="'Jost'" font-size="18px">41</text>
                      <text class="lbl" transform="matrix(1 0 0 1 231.3335 628.1497)" font-family="'Jost'" font-size="18px">31</text>
                      <text class="lbl" transform="matrix(1 0 0 1 256.3335 619.1497)" font-family="'Jost'" font-size="17px">32</text>
                      <text class="lbl" transform="matrix(1 0 0 1 276.3335 602.483)" font-family="'Jost'" font-size="18px">33</text>
                      <text class="lbl" transform="matrix(1 0 0 1 286.6669 573.1497)" font-family="'Jost'" font-size="21px">34</text>
                      <text class="lbl" transform="matrix(1 0 0 1 303.6327 538.667)" font-family="'Jost'" font-size="21px">35</text>
                      <text class="lbl" transform="matrix(1 0 0 1 322.983 495.5432)" font-family="'Jost'" font-size="21px">36</text>
                      <text class="lbl" transform="matrix(1 0 0 1 325.1251 449.1686)" font-family="'Jost'" font-size="21px">37</text>
                      <text class="lbl" transform="matrix(1 0 0 1 324.0004 402.1405)" font-family="'Jost'" font-size="21px">38</text>
                      <text class="lbl" transform="matrix(1 0 0 1 312.8534 324.1021)" font-family="'Jost'" font-size="21px">28</text>
                      <text class="lbl" transform="matrix(1 0 0 1 315.3335 275.3333)" font-family="'Jost'" font-size="21px">27</text>
                      <text class="lbl" transform="matrix(1 0 0 1 311.3335 236)" font-family="'Jost'" font-size="21px">26</text>
                      <text class="lbl" transform="matrix(1 0 0 1 300.3335 200.6667)" font-family="'Jost'" font-size="21px">25</text>
                      <text class="lbl" transform="matrix(1 0 0 1 286.6669 172)" font-family="'Jost'" font-size="21px">24</text>
                      <text class="lbl" transform="matrix(1 0 0 1 270.2269 142.439)" font-family="'Jost'" font-size="21px">23</text>
                      <text class="lbl" transform="matrix(1 0 0 1 252.0000 118.9722)" font-family="'Jost'" font-size="21px">22</text>
                      <text class="lbl" transform="matrix(1 0 0 1 227.8432 112.9722)" font-family="'Jost'" font-size="21px">21</text>
                      <text class="lbl" transform="matrix(1 0 0 1 200.1766 112.9722)" font-family="'Jost'" font-size="21px">11</text>
                      <text class="lbl" transform="matrix(1 0 0 1 170.5099 117.6388)" font-family="'Jost'" font-size="21px">12</text>
                      <text class="lbl" transform="matrix(1 0 0 1 148.6667 134.167)" font-family="'Jost'" font-size="21px">13</text>
                      <text class="lbl" transform="matrix(1 0 0 1 131.3605 164.8335)" font-family="'Jost'" font-size="21px">14</text>
                      <text class="lbl" transform="matrix(1 0 0 1 119.3927 195.6387)" font-family="'Jost'" font-size="21px">15</text>
                      <text class="lbl" transform="matrix(1 0 0 1 103.8631 234.4391)" font-family="'Jost'" font-size="21px">16</text>
                      <text class="lbl" transform="matrix(1 0 0 1 96.2504 275.9999)" font-family="'Jost'" font-size="21px">17</text>
                      <text class="lbl" transform="matrix(1 0 0 1 93.9767 324.769)" font-family="'Jost'" font-size="21px">18</text>
                  </g>
                            <g id="dmftLabels">
                                <text class="txtTooth" transform="matrix(1 0 0 1 5.0001 386.3778)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 0.9998 449.7374)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 9.6668 513.5912)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 36.3335 578.2579)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 74.3335 626.9246)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 109.0001 660.9246)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 145.6668 678.2579)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 191.6668 687.5912)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 233.0001 687.5915)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 283.0001 673.5915)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 329.6668 644.9248)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 359.6668 604.9248)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 390.3334 558.2581)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 412.6435 494.2493)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 416.1565 449.7382)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 409.9765 386.378)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 410.5356 325.845)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 414.0005 251.8453)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 408.7707 211.7113)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 386.7073 165.7383)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 360.5876 123.5825)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 344.0069 89.5916)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 301.0546 54.1648)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 229.2251 29.2916)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 172.7413 30.3285)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 114.3296 51.5455)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 72.0002 91.2056)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 48.5357 127.8719)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 27.2052 167.0134)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 8.7983 212.3336)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 3.25 260.1059)" font-family="'Jost'" font-size="16px">DFM</text>
                                <text class="txtTooth" transform="matrix(1 0 0 1 5.0001 338.4393)" font-family="'Jost'" font-size="16px">DFM</text>
                            </g>
                            <g id="Spots">
                ...
                <div class="work-fields">
                    @if(auth()->user()->role == 'admin')
                        <div class="form-group select-px-15">
                            <label for="type_of_work">{{ __('app.edit_for_user') }}:</label> <span> {{ $work->user->first_name }} {{ $work->user->last_name }} => {{ $work->user->email }}</span>
                        </div>
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="parameters" id="parameters_payload" value="">
                    ...
                    <div class="work-add-remove">
                        <div class="">
                            ...
                            <div class="modal fade" id="parameters-modal" tabindex="-1" aria-labelledby="parametersModalLabel" aria-hidden="true">
                    ...
                    <div class="d-flex justify-content-sm-between align-items-center mb-3">
                        ...
                        <div id="uploads-container">
                            ...
                            @foreach($work->files ?? [] as $index => $upload)
                                <div class="card card-default card-md mb-4 upload-card"
                                     data-existing="1"
                                    ...
                                    <div class="card-header py-20">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-danger btn-remove-upload" style="float:right;">
                                            {{ __('app.remove') }}
                                        </button>
                                    </div>
                                        ...
                                        <div class="dm-tag-wrap">
                                            <div class="dm-upload">
                                                <div class="dm-upload__button">
                                                    {{-- EXISTING FILE → NO INPUT --}}
                                                    <a href="javascript:void(0)"
                                                       class="btn btn-lg btn-outline-lighten btn-upload disabled">
                                                        <img class="svg"
                            ...
                            @endforeach
                                ...
                                <template id="upload-template">
                                    <div class="card card-default card-md mb-4 upload-card" data-existing="0">
                                        <div class="card-header py-20">
                                            <h6>Upload file</h6>
                                            <button type="button"
                        ...
                        <input type="hidden" name="deleted_uploads" id="deleted_uploads" value="[]">
                ...
                <input type="hidden" id="groups_payload" name="groups_payload">
...
@section('additionalPageJS')
    @php
        $groups = [];
        $colors = ['#FF6B6B','#4D96FF','#6BCB77','#FFD93D','#FF8FAB','#845EC2','#00C9A7','#FF9671'];
        $colorIndex = 0;

        foreach ($work->items as $item) {

            $key = md5(
                $item->work_type_id . '-' . ($item->material_id ?? 0) . '-' . ($item->parameters ?? '')
            );

            if (!isset($groups[$key])) {

                $rawParams = $item->parameters ? json_decode($item->parameters, true) : [];
                ...
                foreach ($rawParams as $label => $value) {
                    // Create stable fake ID from label
                    $paramId = crc32($label);

                    $parameters[$paramId] = $value;
                    $parameterLabels[$paramId] = $label;

                    if ($value === 1 || $value === 0) {
                        $parameterFieldTypes[$paramId] = 'boolean';
                    } else {
                        $parameterFieldTypes[$paramId] = 'string';
                    }

                    $parameterOptions[$paramId] = [];
                }

                $groups[$key] = [
                    'id' => $key,
                    'color' => $colors[$colorIndex % count($colors)],
                    'typeOfWorkId' => $item->work_type_id,
                    'typeOfWork' => $item->workType?->name ?? '-',
                    'materialId' => $item->material_id,
                    'material' => $item->material?->name ?? '-',
                    'teeth' => [],
                    'parameters' => $parameters,
                    'parameterLabels' => $parameterLabels,
                    'parameterFieldTypes' => $parameterFieldTypes,
            ...
            if ($item->tooth_number) {
                $groups[$key]['teeth'][] = $item->tooth_number;
            }
        }

        $workData = $work->toArray();
        $workData['groups'] = array_values($groups);
    @endphp

    <script>
        window.__WORK_DATA__ = @json($workData);
        console.log(window.__WORK_DATA__);
    </script>
    <script src="{{ asset('assets/scripts/edit.js') }}"></script>
@endsection
