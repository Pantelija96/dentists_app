                            ...
                            <div class="card-body">
                                <div class="dm-tag-wrap">
                                    <div class="dm-upload">
                                        ...
                                        <div class="dm-upload__file mt-10">
                                            <ul class="list-unstyled mb-0 file-list">
                                                <!-- filename injected here -->
                                            </ul>
                                        </div>
...
@section('additionalPageJS')
    <script src="{{ asset('assets/scripts/teeth-selection2.js') }}"></script>
    ...
    <script>
        ...
        //
        //             // 4) remove dugme postoji na svima sem na prvom
        //             let $removeBtn = $card.find('.btn-remove-upload');
        //
        //             if (index === 1) {
        //                 // prvi blok – nema remove
        //                 $removeBtn.remove();
        //             } else {
        //                 if ($removeBtn.length === 0) {
        //                     // ako ne postoji, dodaj novo dugme u header
        //                     $removeBtn = $(`
        //                 <button type="button"
